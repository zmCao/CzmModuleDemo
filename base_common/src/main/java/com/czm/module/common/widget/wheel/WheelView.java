...
public class WheelView extends View {
	...
	private static  int VALUE_TEXT_COLOR = 0xF0000000;
//	private static int VALUE_TEXT_COLOR = 0xF03CBBC9;
...
//	private static final int ITEMS_TEXT_COLOR = 0xFF999999;
	...
	/** Label offset */
	private static int LABEL_OFFSET = 28;
...
//	private GradientDrawable bottomShadow;
	...
	{
		TEXT_SIZE=(int) MobileUtil.dip2px(mContext,iTextSize);
	}

    /**
     * 设置行高
     * @param iItemHeight 行高
     */
	public void setItemHeight(int iItemHeight)
	{
		ADDITIONAL_ITEM_HEIGHT=(int) MobileUtil.dip2px(mContext, iItemHeight);
	}
	/**
	 * 设置选中值颜色
	 * @param iValueTextColor
	 */
	public void setValueTextColor(int iValueTextColor)
	{
		VALUE_TEXT_COLOR=iValueTextColor;
	}
	/**
	 * 描述：设置中间的选中层图片.
	 *
	...
	public void setCenterSelectDrawable(Drawable centerSelectDrawable) {
		this.centerDrawable = centerSelectDrawable;
	}
	/**
	 * Gets wheel adapter
	 * @return the adapter
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			//去掉阴影
			//valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xFFF);
		}

		if (centerDrawable == null) {
			//centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val);
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_select_line);
		}
